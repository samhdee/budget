<div
    id="modal-benef-delete"
    class="modal fade modal-form"
    tabindex="-1"
    aria-labelledby="benef-delete-title"
    aria-hidden="true"
>
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form id="benef-delete-form" method="DELETE" action="{{ route('benef_delete') }}">
                <div class="modal-header">
                    <h3 class="modal-title fs-4" id="benef-delete-title"></h3>
